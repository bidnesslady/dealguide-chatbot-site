      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4">AI-powered deal analysis to help professionals make better business decisions.</p>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center text-slate-400">
          <p>&copy; {new Date().getFullYear()} DealGuide AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
